 ...
 <div class="container-fluid  pt-5">
  ...
  <div class="col ">
    <div class="card  bggrdnt itemcent">
      <div class="card-body">
        <h2 class="card-title text-center">Code Verification</h2>
  ...
  <div class="form-group">
    <label for="formGroupExampleInput"><h4 class="pt-3">Enter code</h4></label>
...
<!------------------------------------------ address -------------------------------------------->
 <!--  <div class="form-group">
    ...
    <input class="form-control " name="usAddress" type="text" placeholder="">
        ...
        <!------------------------------------------ submit -------------------------------------------->
       <div class="text-center pt-2"> <button class="btn btn-success" id="clme" name="check-reset-otp">Submit</button></div>
