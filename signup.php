...
<!-- header  -->
 ...
 <div class="container-fluid  pt-5">
        <form action="signup.php" method="post" class=" " utocomplete="">
        <div class="row p-3 ">
 ...
 <!------------------------------------------ name -------------------------------------------->
  <div class="form-group">
    <label for="formGroupExampleInput"><h4 class="pt-3">Name</h4></label>
  ...
  <div class="form-group">
    ...
    <input class="form-control " nname="password" type="password" placeholder="">
  </div>
  <!------------------------------------------ repeat Password -------------------------------------------->
  <div class="form-group">
    <label for="formGroupExampleInput"><h4 class="pt-3">Confirm Password</h4></label>
    <input class="form-control " nname="cpassword" type="password" placeholder="">
  </div>
<!------------------------------------------ role -------------------------------------------->
  <!-- <div class="form-group">
...
<!------------------------------------------ address -------------------------------------------->
 <!--  <div class="form-group">
    ...
    <input class="form-control " name="usAddress" type="text" placeholder="">
        ...
        <!------------------------------------------ submit -------------------------------------------->
       <div class="text-center pt-2"> <button class="btn btn-success" id="clme" name="signup">Submit</button></div>
        <div class="link login-link text-center pt-2">Already a member? <a href="login-user.php">Login here</a></div>
      </div>
    </div>
  </div>
