...
<!-- header  -->
 ...
 <div class="container-fluid  pt-5">
  ...
  <div class="form-group">
    <label for="formGroupExampleInput"><h4 class="pt-3">Create new password</h4></label>
  ...
  <div class="form-group">
    <label for="formGroupExampleInput"><h4 class="pt-3">Confirm your password</h4></label>
